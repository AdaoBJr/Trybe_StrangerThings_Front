...
- [Requisitos do projeto](#requisitos-do-projeto)
    - [Backend](#backend-1)
      - [1 - Variáveis de ambiente](#1---verifica-as-variáveis-de-ambiente)
      - [2 - Módulo PM2](#2---verifica-se-o-módulo-pm2-foi-instalado-no-projeto)
      - [3 - Ecosystem](#3---verifica-a-configuração-do-ecosystemconfigyml)
      - [4 - Scripts package.json](#4---verifica-se-os-scripts-do-packagejson-estão-corretos)
      - [5 - Procfile](#5---verifica-a-configuração-do-arquivo-procfile)
      - [6 - Deploy no Heroku](#6---verifica-o-deploy-no-heroku)
    - [Frontend](#frontend-2)
      - [7 - Variáveis de Ambiente](#7---verifica-as-variáveis-de-ambiente-do-frontend)
      - [8 - Deploy do frontend no Heroku](#8---verifica-se-foi-feito-o-deploy-do-frontend-no-heroku)
    - [Bônus](#bônus)
      - [9 - Multi-ambientes e Development Mode.](#9---verifica-os-multi-ambientes-e-modo-de-desenvolvimento)
