...
const REACT_APP_HAWKINS_URL = process.env.REACT_APP_HAWKINS_URL || 'https://fabiomarturanojr-bk.herokuapp.com/';
const REACT_APP_HAWKINS_TIMEOUT = process.env.REACT_APP_HAWKINS_TIMEOUT || TRINTA_MIL;
const REACT_APP_UPSIDEDOWN_URL = process.env.REACT_APP_UPSIDEDOWN_URL || 'https://fabiomarturanojr-bd.herokuapp.com/';
